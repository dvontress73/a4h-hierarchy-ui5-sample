		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#classificationhierarchy-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"classificationhierarchy-display": {
								"semanticObject": "classificationhierarchy",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=classificationhierarchy",
									"url": sap.ui.require.toUrl("classificationhierarchy")
								}
							}
						}
					}
